...
My strongest fit is a combination of Python, MySQL-backed production workflows, secure backend tooling, and careful AI-assisted development. At AAIS, I used MySQL extensively across data engineering and software engineering work, including a manual MySQL/SQL billing process automated with Python, PySpark, and AWS Glue over 20+ TB of production insurance data for 700+ member companies; profiling 160+ MySQL/Oracle/Impala tables with Python, Pandas, SQL, and JDBC; and building validation, reverse-ETL, IAM, Lambda, and S3 workflows that improved issue diagnosis and made data access more controlled. At SmartSolve, I built secure internal software with Next.js, TypeScript, PostgreSQL, Drizzle ORM, SSO, auth middleware, and Docker-based development environments while using Codex and Claude Code for planning and review. I have also worked on reliability fixes and auditability in an AWS-hosted healthcare workflow platform. I would bring Pinterest a grounded backend engineering mindset: use data to diagnose problems, automate carefully, communicate tradeoffs clearly, and apply AI tools only with validation and ownership of the result.
